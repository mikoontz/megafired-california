...
# sort(cor(fires[, predictor.variable.names])[, "landcover_diversity"])
...
# The tuned model (auc = 0.973) performs worse than the original one (auc = 0.974). Tuning not required, returning the original model.
# Tuning results stored in model$tuning.
