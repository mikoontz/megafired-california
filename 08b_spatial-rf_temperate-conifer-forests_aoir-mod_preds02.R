...
fires_working <- 
  fires %>% 
  dplyr::mutate(peak_ridge_prop = csp_ergo_landforms_11_prop + csp_ergo_landforms_12_prop + csp_ergo_landforms_13_prop + csp_ergo_landforms_14_prop,
                cliff_prop = csp_ergo_landforms_15_prop,
                upper_slope_prop = csp_ergo_landforms_21_prop + csp_ergo_landforms_22_prop + csp_ergo_landforms_23_prop,
                flat_prop = csp_ergo_landforms_24_prop + csp_ergo_landforms_34_prop,
                lower_slope_prop = csp_ergo_landforms_32_prop + csp_ergo_landforms_33_prop + csp_ergo_landforms_31_prop,
  ...
  as.data.frame() %>% 
  dplyr::mutate(peak_ridge_binary = ifelse(peak_ridge_prop > 0.03, 1, 0),
                valley_binary = ifelse(valley_prop > 0.08, 1, 0),
                peak_ridge_binary_prop_inter = peak_ridge_binary * peak_ridge_prop,
                valley_binary_prop_inter = valley_binary * valley_prop)
...
# TEST SET
human_drivers <- c("npl", "concurrent_fires", "friction", "friction_walking_only", "road_density_mpha")
topography_drivers <- c("elevation", "rumple_index", "peak_ridge_prop", "cliff_prop", "upper_slope_prop", "flat_prop", "lower_slope_prop", "valley_prop", "peak_ridge_binary", "valley_binary", "peak_ridge_binary_prop_inter", "valley_binary_prop_inter")
# topography_drivers <- c("elevation", "rumple_index", "peak_ridge_warm_prop", "peak_ridge_prop", "peak_ridge_cool_prop", "mountain_divide_prop", "cliff_prop", "upper_slope_warm_prop", "upper_slope_prop", "upper_slope_cool_prop", "upper_slope_flat_prop", "lower_slope_warm_prop", "lower_slope_prop", "lower_slope_cool_prop", "lower_slope_flat_prop", "valley_prop", "valley_narrow_prop")
...
# topography_drivers <- c("elevation", "rumple_index", "peak_ridge_prop", "cliff_prop", "upper_slope_prop", "flat_prop", "lower_slope_prop", "valley_prop")
# # topography_drivers <- c("elevation", "rumple_index", "peak_ridge_warm_prop", "peak_ridge_prop", "peak_ridge_cool_prop", "mountain_divide_prop", "cliff_prop", "upper_slope_warm_prop", "upper_slope_prop", "upper_slope_cool_prop", "upper_slope_flat_prop", "lower_slope_warm_prop", "lower_slope_prop", "lower_slope_cool_prop", "lower_slope_flat_prop", "valley_prop", "valley_narrow_prop")
# weather_drivers <- c("wind_anisotropy", "max_wind_speed_pct", "min_wind_speed_pct", 
#                      "max_temp_pct", "min_temp_pct", 
#                      "max_rh_pct", "min_rh_pct", "max_vpd_pct", "min_vpd_pct", "max_soil_water_pct", "min_soil_water_pct",
...
preference.order <- c(
  ...
  "spei1y", "fm100_pct",
  "ndvi", "forest_structure_rumple", "fuel_slow_loss_prop", "fuel_fast_loss_prop",
