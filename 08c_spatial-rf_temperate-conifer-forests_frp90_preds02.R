...
fires <-
  ...
  dplyr::select(-(starts_with("lcms_landuse")), # remove all landuse raw area coverage and proportion values
                ...
                -lcms_change_05_prop,
                -name_frap, -olap_frap, -ig_date, -last_date, -date, -ends_with("rank"), -aoir_mod, -pred_aoi, -c_area_tm1, -event_dur, -event_modis_lc, -daily_modis_lc,
...
data <- fires_working[!is.na(fires_working$frp_90), ]
...
tcf_nonspatial <- spatialRF::rf(
  ...
  dependent.variable.name = "frp_90",
