...
for (counter in 1:4) {
  ...
  # system2(command = "aws", args = paste0("s3 cp s3://california-megafires/data/out/analysis-ready/FIRED-daily-scale-drivers_california_", biome_shortname, "_v5.csv  data/out/analysis-ready/FIRED-daily-scale-drivers_california_", biome_shortname, "_", drivers_version, ".csv"), stdout = TRUE)  
