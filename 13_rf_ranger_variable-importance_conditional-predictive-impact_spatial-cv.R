...
for (counter in (1:4)) {
  ...
  data.table::fwrite(x = out, file = paste0("data/out/rf/rf_ranger_variable-importance_cpi_classif-fbeta_spatial-cv_", biome_shortname, ".csv"))
  data.table::fwrite(x = out_grouped, paste0(file = "data/out/rf/rf_ranger_variable-importance_cpi_classif-fbeta_grouped_spatial-cv_", biome_shortname, ".csv"))
