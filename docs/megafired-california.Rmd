...
Increasing area burned [@williams2016; @williams2019]
...
Challenge of defining "extreme wildfire events", but can be done by considering fire behavior within the context of fire's controllability, but decoupled from the societal impact [@tebim2018].
...
Fire radiative power (FRP) to fireline intensity on a 4x daily timestep, then classification of that day based on @tebim2018.
