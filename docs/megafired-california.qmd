...
Across all spread events, we calculated the 95th percentile of daily area of growth and classified all spread events that exceeded that threshold (corresponding to spread \> xxxx ha) as an “extreme spread event” (ESE).
