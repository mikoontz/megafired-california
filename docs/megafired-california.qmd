...
@tbl-driver-descriptions provides the source and means of calculating each variable, and we expand on the description for more complicated derived variables here.
