...
weather_drivers <- 
  data.frame(type = "weather",
             variable = c("wind_dir_ns_era5", "wind_dir_ew_era5",
                          "wind_anisotropy_ns_era5", "wind_anisotropy_ew_era5", 
                          "min_wind_speed_era5_pct", "max_wind_speed_era5_pct", 
                          "min_rh_era5_pct", "max_rh_era5_pct",
                          "min_temp_era5_pct", "max_temp_era5_pct", 
             ...
             source = c(rep("Daily summary derived for this paper from ERA5 Reanalysis Land", times = 4),
                        rep("Daily summary and percentiles derived for this paper from ERA5 Reanalysis Land", times = 2),
                        rep("Daily summary and percentiles derived for this paper from ERA5 Reanalysis Land", times = 4),
                        rep("Calculations, daily summary, and percentiles derived for this paper from ERA5 Reanalysis Land", times = 2),
             ...
             calculation = c("mean of cosine of hourly wind directions each day",
                             ...
                             "minimum percentile of hourly sustained wind speed in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
                             "maximum percentile of hourly sustained wind speed in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
                             "minimum percentile of hourly relative humidity in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
                             "maximum percentile of hourly relative humidity in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
                             "minimum percentile of hourly temperature in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
                             "maximum percentile of hourly temperature in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
                             "minimum percentile of hourly vapor pressure deficit in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
                             "maximum percentile of hourly vapor pressure deficit (VPD) in a day compared to hourly VPD between 1979-01-01 and 2020-12-31",
